...
create table ink_sys_role_menu
(
  id bigint auto_increment
    primary key,
...
create table ink_sys_user_role
(
  id bigint auto_increment
    primary key,
