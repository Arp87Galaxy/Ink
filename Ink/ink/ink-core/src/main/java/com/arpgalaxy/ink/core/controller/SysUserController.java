...
public class SysUserController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("core:sysuser:list")
    ...
    @RequiresPermissions("core:sysuser:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("core:sysuser:save")
    ...
    @RequiresPermissions("core:sysuser:update")
    ...
    @RequiresPermissions("core:sysuser:delete")
